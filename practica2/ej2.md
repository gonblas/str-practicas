...
## (a) Comprobación de planificación viable
...
## (b) Desarrollo de un plan cíclico
...
- Máximo tiempo de ejecución: $C_\text{max} = 7 \rightarrow f \ge 7$  
- Probar $f = 10$ (una opción razonable, mayor o igual a 7 y múltiplo práctico):

Verificación de la condición: $2f - \text{MCD}(T_i, f) \le D_i$

| Tarea | $C_i$ | $T_i$ | $2f - \text{MCD}(T_i, f)$ | $D_i$ | Cumple? |
| ----- | ----- | ----- | -------------------------- | ----- | ------- |
| A     | 1     | 10    | $20 - \text{MCD}(10,10)=20-10=10$ | 10    | Sí      |
| B     | 3     | 12    | $20 - \text{MCD}(12,10)=20-2=18$  | 12    | No      |
| C     | 7     | 20    | $20 - \text{MCD}(20,10)=20-10=10$ | 20    | Sí      |
| D     | 1     | 5     | $20 - \text{MCD}(5,10)=20-5=15$   | 5     | No      |

- Resultado: $f = 10$ **no cumple** para todas las tareas.  
- Probar $f = 5$ (menor, pero $f \ge C_\text{max} \rightarrow C_\text{max}=7 \rightarrow 5<7$ ❌).  
- Probar $f = 15$ ($\ge C_\text{max}=7$):

  | Tarea | $2f - \text{MCD}(T_i,f)$ | $D_i$ | Cumple? |
  | ----- | ------------------------ | ----- | ------- |
  | A     | $30 - \text{MCD}(10,15)=30-5=25$ | 10    | No      |
  | B     | $30 - \text{MCD}(12,15)=30-3=27$ | 12    | No      |
  | C     | $30 - \text{MCD}(20,15)=30-5=25$ | 20    | No      |
  | D     | $30 - \text{MCD}(5,15)=30-5=25$  | 5     | No      |
